...
@section('content')
    ...
    @include('customers.categories.add-modal')


    @include('customers.categories.edit-modal')
            ...
            <div class="widget-box">
                ...
                <div class="widget-header">
                    <h4 class="widget-title">
                        <i class="fa fa-info-circle"></i> Customer Category
                    </h4>

                    <span class="widget-toolbar">
                        @if (hasPermission('dokani.cus_categories.create', $slugs))
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group btn-corner">
                                                        @if (hasPermission('dokani.cus_categories.edit', $slugs))
                                                        ...
                                                        @if (hasPermission('dokani.cus_categories.delete', $slugs))
                                                            <button type="button"
                                                                onclick="delete_item(`{{ route('dokani.cus_categories.destroy', $item->id) }}`)"
...
@section('js')
    ...
    <script>
        ...
        const update_route = `{{ route('dokani.cus_categories.update', ':id') }}`
