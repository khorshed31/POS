            ...
            <div class="widget-box">
                <div class="widget-header no-print">
                    <h4 class="widget-title">
                        <i class="fa fa-plus-circle"></i> Payment
                    </h4>
                        ...
                        <div class="row">
                            ...
                            <div id="print_body" class="col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="customerInfo" style="width: 50%;float: left;">
                                            ...
                                            <p class="supplier"><b>Name : </b>
                                                {{ optional($payment->supplier)->name }}</p>

                                            <p class="supplier"><b>Mobile : </b>
                                                {{ optional($payment->supplier)->mobile }}</p>
                                        </div>
                                        ...
                                        <div class="invoiceInfo" style="width: 50%; float: left;margin-top: 5px;">
                                            <table class="table table-bordered">
                                                ...
                                                @if(optional($payment->account)->name == 'Bank')
                                                    <tr>
                                                        <td>Bank Account Info. : </td>
                                                        <td>
                                                            Check No : <strong>{{ $payment->check_no }}</strong>, Check Date : <strong>{{ $payment->check_date }}</strong>
                                                        </td>
                                                    </tr>
                                                @endif
                                ...
                                <div class="invoice-content">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" style="border: none !important">
                                            ...
                                            <tr class="heading">
                                                ...
                                                <th style="border: 1px solid #f0d9d9;">Supplier</th>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h5> Paid Amount : BDT<span> {{ number_format($payment->paid_amount, 2) }}</span>
                                            </h5>
                                            @if ($payment->due_amount > 0)
                                                <h5> Due Amount :<span>
                                                    <strong>{{ getInWord($payment->due_amount) }}</strong>
                                                    </span></h5>
                                            @endif
                                        </div>
                                    </div>
