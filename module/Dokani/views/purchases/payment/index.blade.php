                ...
                <div class="widget-header">
                    ...
                    <span class="widget-toolbar">
                        @if (hasPermission('dokani.payments.create', $slugs))
                            <a href="{{ route('dokani.payments.create') }}" class="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group btn-corner">
                                                            ...
                                                            <!-- show -->
                                                            <a href="{{ route('dokani.payments.show', $item->id) }}"
                                                                role="button" class="btn btn-sm btn-primary" title="Show">
                                                                <i class="fa fa-eye"></i>
                                                            </a>

{{--                                                            <!-- edit -->--}}
{{--                                                            <a href="{{ route('dokani.payments.edit', $item->id) }}"--}}
...
{{--                                                            </a>--}}
                                                            ...
                                                            <!-- delete -->
                                                            <button type="button"
                                                                onclick="delete_item(`{{ route('dokani.payments.destroy', $item->id) }}`)"
                                    ...
                                    @include('partials._paginate',['data'=> $payments])
