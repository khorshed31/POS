            ...
            <div class="widget-box">
                ...
                <div class="widget-header">
                    ...
                    <span class="widget-toolbar">
                        @if (hasPermission('dokani.units.store', $slugs))
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group btn-corner">
                                                        @if (hasPermission('dokani.units.update', $slugs))
                                                        ...
                                                        @if (hasPermission('dokani.units.delete', $slugs))
                                                            <button type="button"
                                                                onclick="delete_item(`{{ route('dokani.units.destroy', $item->id) }}`)"
...
@section('js')
    ...
    <script>
        ...
        const update_route = `{{ route('dokani.units.update', ':id') }}`
