            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <form method="POST" action="{{ route('dokani.ac.accounts.update',$account->id) }}" class="form-horizontal"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="text" name="name" autocomplete="off"
                                           value="{{ $account->name }}" placeholder="Type Account Name" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control only-number" type="text" name="opening_balance"
                                           value="{{ $account->opening_balance }}" placeholder="Enter Opening Balance" readonly/>
                                </div>
                            </div>
