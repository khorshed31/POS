...
@section('page-header')
    <i class="fa fa-info-circle"></i> Advance
@stop
                ...
                <div class="widget-header">
                    ...
                    <span class="widget-toolbar">
                        @if (hasPermission('dokani.advances.create', $slugs))
                            <a href="{{ route('dokani.advances.create') }}" class="">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" name="name" value="{{ request('name') }}"
                                                       class="form-control input-sm" placeholder="Employee name">
                                            </td>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-responsive" style="border: 1px #cdd9e8 solid;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group btn-corner">
                                                        ...
                                                        <!-- edit -->
                                                        @if (hasPermission('dokani.advances.edit', $slugs))
                                                            <a href="{{ route('dokani.advances.edit', $item->id) }}"
                                                    ...
                                                    <!-- delete -->
                                                        @if (hasPermission('dokani.advances.delete', $slugs))
                                                            <button type="button"
                                                                    onclick="delete_item(`{{ route('dokani.advances.destroy', $item->id) }}`)"
                                    ...
                                    @include('partials._paginate',['data'=> $advances])
